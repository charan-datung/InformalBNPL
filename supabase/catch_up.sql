...
do $$ begin
  if not exists (select 1 from pg_type where typname = 'escrow_event_type') then
...
-- -----------------------------------------------------------------------------
create index if not exists loans_buyer_idx on public.loans (buyer_user_id);
create index if not exists loans_seller_idx on public.loans (seller_user_id);
create index if not exists loans_status_idx on public.loans (status);
create index if not exists escrow_events_loan_idx on public.escrow_events (loan_id);
create index if not exists repayments_loan_idx on public.repayments (loan_id);
create index if not exists disputes_loan_idx on public.disputes (loan_id);
...
drop trigger if exists escrow_events_append_only on public.escrow_events;
...
drop policy if exists repayments_select on public.repayments;
...
-- ===== from migration: 20260618130000_loan_mutations.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618140000_seller_verification_storage.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618150000_release_escrow.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618160000_audit_log.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618170000_buyer_dispute.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618180000_repayments.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618190000_shipment_proof.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618200000_admin_override.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618210000_auto_release_cron.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618220000_buyer_application.sql =====
-- =============================================================================
...
-- ===== from migration: 20260618230000_datung_pay.sql =====
-- =============================================================================
...
-- ===== from migration: 20260619000000_hardening_guards.sql =====
-- =============================================================================
...
-- ===== from migration: 20260619120000_informal_seller_model.sql =====
-- =============================================================================
...
drop trigger if exists seller_graduation_on_settle on public.loans;
...
-- ===== from migration: 20260619140000_maker_checker_payouts.sql =====
-- =============================================================================
...
-- ===== from migration: 20260619160000_repayment_ledger.sql =====
-- =============================================================================
...
-- ===== from migration: 20260624000000_seller_ocr.sql =====
...
-- ===== from migration: 20260625000000_seller_referrals.sql =====
-- =============================================================================
...
do $$ begin
  if not exists (select 1 from pg_constraint where conname = 'seller_referrals_no_self') then
    alter table public.seller_referrals add constraint seller_referrals_no_self check (referrer_user_id <> referred_user_id);
  end if;
end $$;
...
-- ===== from migration: 20260626000000_capitalized_processing_fee.sql =====
-- =============================================================================
...
-- ===== from migration: 20260626010000_document_acceptances.sql =====
-- =============================================================================
...
-- ===== from migration: 20260629020000_webauthn_credentials.sql =====
-- =============================================================================
...
-- ===== from migration: 20260629030000_repayment_reminders.sql =====
-- =============================================================================
...
-- ===== from migration: 20260629040000_payments.sql =====
-- =============================================================================
...
-- ===== from migration: 20260630000000_seller_sells_what.sql =====
-- =============================================================================
...
-- ===== from migration: 20260630010000_location_tracking.sql =====
-- =============================================================================
